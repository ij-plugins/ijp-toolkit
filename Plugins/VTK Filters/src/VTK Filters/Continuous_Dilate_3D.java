...
import net.sf.ij.vtk.ContinuousErode3D;
import net.sf.ij.vtk.ContinuousDilate3D;

/**
 *  Plugin for running vtkContinuousDilate3D filter from VTK.
 *
 * @author   Jarek Sacha
...
public class Continuous_Dilate_3D implements PlugIn {

  private static ContinuousDilate3D vtkFilter;
  ...
  public void run(String arg) {
    ...
    if (vtkFilter == null) {
      vtkFilter = new ContinuousDilate3D();
    }

    GenericDialog dialog = new GenericDialog("Continuous Erode 3D Options");
    ...
    output.setTitle(imp.getTitle() + "-Continuous Erode 3D");
    output.show();
  }
}
