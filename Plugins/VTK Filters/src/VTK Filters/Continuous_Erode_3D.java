...
/**
 *  Plugin for running vtkContinuousErode3D filter from VTK.
 *
 * @author   Jarek Sacha
...
public class Continuous_Erode_3D implements PlugIn {
  ...
  private static ContinuousErode3D vtkFilter;
  ...
  public void run(String arg) {
    ...
    if (vtkFilter == null) {
      vtkFilter = new ContinuousErode3D();
    }
