...
abstract public class ConnectedThresholdFilterBase {
    ...
    /**
     * Used to mark pixels that were determined to not be members. This value is changed to BACKGROUND
     * in the output image.
     */
    ...
    */
    ...
    /**
     * Create handle to source pixels, e.g. byte[][] srcPixels. This method is called at the begining
     * of the initialize method. This method should only modify handle to source piels that is defined
     * in the derived class. This handle is used by checkForGrow()
     */
