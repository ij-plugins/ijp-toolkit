...
public class MiTag extends Enumeration {
     ...
     * 'False'. Default is the same as native type for the platform on which program runs. This tag is
     * not required, however, it use is highly recommended to avoid problems reading images on other
     * platforms. <br> Note: MSB is native for Java and most computers not using Intel compatible
     * processors, e.g. Mac or most UNIX computers (excluding most flavors of Linux that run on Intel
