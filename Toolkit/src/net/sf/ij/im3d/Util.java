...
public class Util {
    ...
    /**
     * Computes a bounding box for an image. A bounding box attempts to exclude voxels with value zero
     * that are close to image borders.
     *
    ...
    /**
     * Decode value of the origin property of image <code>imp</code>. The origin is stored in property
     * values 'origin.x', 'origin.y', and 'origin.z'. If a properly is missing or cannot be parsed as
     * a number it is assumed to be equal zero.
     *
